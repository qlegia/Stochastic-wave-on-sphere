...
import math
#################################################
# usage :python3 waveU0  Lmax 
#        python3 waveU0  600    : generate homogeneous soln at tau   
#
tau = 4*1e-4 
kappa1= 4.1
kappa2= 2.5
...
sv_fig = map_type + '_Lmax' + str(Lmax) + '_t0.png'
#sv_fig = map_type + '_Lmax' + str(Lmax) + '_t0_kap1_4p1.png'
plt.figure(1)
cm = cmbcmap()
